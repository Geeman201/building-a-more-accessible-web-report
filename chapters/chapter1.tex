...
me to make and justify difficult decisions under pressure. For example deciding
 ...
 it impacted the project. The manifesto for this project will be:
\begin{itemize}
...
and then using that feedback to direct new requirements. It's flexible enough
 and well structured for this project. What pushed me towards Unified Process over Spiral was the amount of risk
collection and analysis required. Due to being an individual project, most
risks fall into the low probability, low impact category, and one quater of
each spiral is dedicated to risk analysis.
...
of the elaboration, and most of the construction phase. This lead to the
decision to change from 'Unified Process' towards a more iterative
'Evolutionary' process, 'Evolutionary Prototyping'. Due to the short
timescales and well defined requirements (which were formed during the
completed Inception \& Start of Elaboration) this
felt like the best method to produce a high quality product quickly.
